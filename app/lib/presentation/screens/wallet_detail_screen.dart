...
/// Tactile physical hero card with tap-to-copy feedback and shared element Hero morph.
...
/// Dedicated Full-Screen View for Account Details & Mutations.
///
/// Features:
/// - Shared-element `Hero` morph transition directly from the resting card deck.
/// - Atmospheric ambient radial glow matching the card's specific theme palette.
/// - Frosted blurred sticky top header with back navigation button, account badge, dynamic scrolled balance pill.
/// - Hero Physical ATM Card with 3D tactile texture, masked account numbering, and tap-to-copy.
...
class WalletDetailScreen extends StatefulWidget {
  ...
  /// Navigates to the dedicated account details screen with shared element hero transition.
        ...
        return Scaffold(
          ...
          body: Stack(
            children: [
              ...
              Positioned.fill(
                child: CustomScrollView(
                  ...
                  slivers: [
                    ...
                    SliverToBoxAdapter(
                      child: SizedBox(height: MediaQuery.paddingOf(context).top + 68),
                    ),
                              ...
                              child: _PressableScale(
                                onTap: () {
                                  showModalBottomSheet(
                                    ...
                                    builder: (sheetContext) => TransactionModal(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    boxShadow: [
                                      BoxShadow(
                                        color: AppColors.neoMint.withValues(alpha: 0.28),
                                        blurRadius: 16,
              ...
              // Sticky App Bar with Back Button, Dynamic Scrolled Balance Pill
              Positioned(
                top: 0,
                left: 0,
                right: 0,
