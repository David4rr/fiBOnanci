...
class ModernistPaintersBase {
  static void paintTerracottaDisks(Canvas canvas, Size size, Color primaryColor) {
    final paint = Paint()
      ..color = primaryColor
  ...
  static void paintSageHatching(Canvas canvas, Size size, Color primaryColor) {
    final paint = Paint()
  ...
  static void paintPeriwinkleOvals(Canvas canvas, Size size, Color primaryColor) {
    final paint = Paint()
  ...
  static void paintNeonSunburst(Canvas canvas, Size size) {
  ...
  static void paintOatmealWaves(Canvas canvas, Size size, Color primaryColor) {
    final paint = Paint()
  ...
  static void paintGeometricCurves(Canvas canvas, Size size, Color primaryColor) {
    final paint = Paint()
